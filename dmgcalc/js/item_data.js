...
function getFlingPower(item) {
  return item === "Iron Ball"
    ? 130
    : item === "Hard Stone"
    ? 100
    : item.indexOf("Plate") !== -1 ||
      ["Deep Sea Tooth", "Thick Club"].indexOf(item) !== -1
    ? 90
    : ["Assault Vest", "Weakness Policy"].indexOf(item) !== -1
    ? 80
    : ["Poison Barb", "Dragon Fang"].indexOf(item) !== -1
    ? 70
    : ["Adamant Orb", "Lustrous Orb", "Macho Brace", "Stick"].indexOf(item) !==
      -1
    ? 60
    : item === "Sharp Beak"
    ? 50
